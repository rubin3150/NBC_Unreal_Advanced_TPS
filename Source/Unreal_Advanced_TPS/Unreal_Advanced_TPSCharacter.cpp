...
//////////////////////////////////////////////////////////////////////////
// AUnreal_Advanced_TPSCharacter

AUnreal_Advanced_TPSCharacter::AUnreal_Advanced_TPSCharacter()
{
...
void AUnreal_Advanced_TPSCharacter::NotifyControllerChanged()
{
...
void AUnreal_Advanced_TPSCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AUnreal_Advanced_TPSCharacter::Move);

		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &AUnreal_Advanced_TPSCharacter::Look);
	}
	else
	{
...
void AUnreal_Advanced_TPSCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AUnreal_Advanced_TPSCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
